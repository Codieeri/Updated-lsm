...
const JOBS: Job[] = [
  ...
  { title: "Data Analyst Intern",                 dept: "product",       type: "Full Time",  location: "Remote",   openings: 2  , image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&q=80" },
  ...
  { title: "AI Web Developer Intern",             dept: "web",           type: "Full Time",  location: "Remote",   openings: 18 , image: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=600&q=80" },
...
export default function App() {
  ...
  const handleJobClick = (title: string) => {
    const detail = JOB_DETAILS.find((j) => j.title === title);
    if (detail) {
